...
public class NumberToWords {
    ...
    public static void main(String...args) {
        ...
        String output = processor.getName("111234.45");
    ...
    static abstract public class AbstractProcessor {
        ...
        protected ArrayList<Integer> getDigits(long value) {
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            if (!(null == decimalValue || decimalValue.isEmpty())) {
                ...
                name = name.concat(getDecimalValue(decimalValue)).concat(SEPARATOR).concat("dollars");
        ...
        private String getDecimalValue(String dvalue) {
        	String retVal = null;
        	if(dvalue.length() <=2) {
        		retVal =  dvalue + "/100";
        	} else {
        		retVal = dvalue.substring(0, 2) + "." + dvalue.substring(2, dvalue.length());
        		Float floatValue = new Float(retVal);
        		Integer intVal = Math.round(floatValue);
        		retVal = intVal + "/100";
        	}
